  ...
  if (interactive()) {
    ...
    isolate({
      ...
      if (rstudioapi::isAvailable() && !is_empty(input$rmd_report) && rmd) {
        path <- file.path(normalizePath("~"),"serenity.sessions")
